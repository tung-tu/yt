          ...
          <div class="row align-items-center">
            ...
            <div class="col-sm-auto">
              <a class="btn btn-primary" href="javascript:;" data-toggle="modal" data-target="#inviteUserModal">
                <i class="tio-user-add mr-1"></i> Mời Bạn Bè
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="row gx-2 gx-lg-3">
          <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                <h6 class="card-subtitle">Đã Nạp</h6>
          ...
          <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                <h6 class="card-subtitle">Đã Mua</h6>
          ...
          <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                <h6 class="card-subtitle">Rate giảm giá</h6>
          ...
          <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <a class="card card-hover-shadow h-100" href="#">
              <div class="card-body">
                <h6 class="card-subtitle">Tiền Thưởng</h6>

                <div class="row align-items-center gx-2 mb-1">
                  <div class="col-6">
                    <span class="card-title h2">92 $</span>
                  </div>
...
<?php  include_once  'data/foot.php';?>